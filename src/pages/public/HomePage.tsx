    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-28 md:py-40 text-center">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1] mb-6">
          <span className="text-foreground">Web Scraping API</span>
          <br />
          <span className="text-gradient-primary">Built for Developers</span>
        </h1>

        <p className="mx-auto max-w-2xl text-lg md:text-xl text-muted-foreground leading-relaxed mb-10">
          Scrape, crawl, map, and extract structured data from any website.
          One API, production-ready reliability, developer-first design.
        </p>
...
const features = [
  {
    icon: Zap,
    title: "Scrape",
    desc: "Fetch clean markdown, HTML, or screenshots from any URL with a single API call.",
  },
  {
    icon: Globe,
    title: "Crawl",
    desc: "Recursively crawl entire websites with depth control, pattern filters, and concurrency.",
  },
  {
    icon: Map,
    title: "Map",
    desc: "Discover all URLs on a domain instantly. Build sitemaps without full page scraping.",
  },
  {
    icon: Brain,
    title: "Extract",
    desc: "Use AI to pull structured JSON data from pages with custom schemas and prompts.",
  },
  {
    icon: Key,
    title: "API Keys",
    desc: "Manage multiple API keys with prefix tracking, rotation, and per-key usage analytics.",
  },
  {
    icon: BarChart3,
    title: "Usage Dashboard",
    desc: "Real-time visibility into credits, job history, success rates, and billing.",
  },
  {
    icon: Shield,
    title: "Reliable",
    desc: "Built-in retries, anti-bot handling, JavaScript rendering, and smart rate limiting.",
  },
  {
    icon: Clock,
    title: "Fast",
    desc: "Optimized pipeline delivers results in seconds. No queues, no waiting.",
  },
];
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            A complete toolkit for web data extraction. From single pages to entire domains.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map((f) => (
            <div
              key={f.title}
              className="group rounded-xl border border-border p-6 surface-1 hover:border-primary/30 transition-all duration-300"
            >
...
function ApiExampleSection() {
  return (
    <section id="api-example" className="py-24 md:py-32 surface-1">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Get clean, structured data from any URL with a single request.
          </p>
        </div>
...
function UseCasesSection() {
  return (
    <section className="py-24 md:py-32 surface-1">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            From startups to enterprises, Nebula Crawl powers data-driven workflows.
          </p>
        </div>

        <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {useCases.map((uc) => (
            <div key={uc.title} className="flex gap-4 p-5 rounded-xl border border-border bg-background">
...
const plans = [
  {
    ...
    features: ["Scrape, Crawl, Map", "Markdown & HTML output", "Community support"],
    cta: "Get Started",
    highlighted: false,
  },
  {
    ...
    features: ["Everything in Free", "AI Extraction", "JavaScript rendering", "Priority support"],
  ...
  },
  {
    ...
    features: ["Everything in Starter", "Higher rate limits", "Webhook notifications", "Dedicated support"],
    cta: "Start Free Trial",
    highlighted: false,
  },
];
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <Button
                ...
                className={plan.highlighted ? "glow-primary" : ""}
                asChild
              >
    ...
    <section className="py-24 md:py-32 surface-1">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <p className="text-muted-foreground text-lg mb-14 max-w-2xl mx-auto">
          Production-hardened infrastructure you can depend on.
        </p>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {trustPoints.map((tp) => (
            <div key={tp.label} className="p-5 rounded-xl border border-border bg-background">
    ...
    <section className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6 text-center">
        ...
        <p className="text-lg text-muted-foreground mb-10 max-w-xl mx-auto">
          Join thousands of developers who trust Nebula Crawl for their web data needs. Start free today.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button size="lg" className="glow-primary-strong text-base px-8" asChild>
            <Link to="/auth">
