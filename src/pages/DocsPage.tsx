...
function snippets(method: "GET" | "POST", path: string, body: Record<string, unknown> | undefined, apiKey: string) {
  ...
  return {
    curl: generateSnippet(def, "curl", apiKey),
    python: generateSnippet(def, "python", apiKey),
    nodejs: generateSnippet(def, "nodejs", apiKey),
  };
}
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <section className="space-y-3">
        ...
        <div className="rounded-lg border border-border p-4 bg-muted/30 space-y-3">
          <p className="text-xs font-medium">Select an API key to auto-populate snippets:</p>
      ...
      <section className="space-y-4">
        ...
        <Tabs defaultValue="scrape">
          ...
          <TabsContent value="crawl" className="space-y-4 mt-4">
            ...
            <LanguageSnippet snippets={snippets("GET", "/crawl/<job_id>", undefined, apiKey)} />
          </TabsContent>
          ...
          <TabsContent value="usage" className="space-y-4 mt-4">
            ...
            <LanguageSnippet snippets={snippets("GET", "/api-usage", undefined, apiKey)} />
          </TabsContent>
        </Tabs>
      </section>
